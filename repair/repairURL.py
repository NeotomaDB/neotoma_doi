...
date: March 23, 2022
by: Simon Goring
Repair existing Neotoma DOI Records.
...
def changeAff(x):
    """Change the affiliation of authors to something empty (not None)
       The older schema allowed us to avoid contributorType fields and
       let us stick in organizations as if they were people. 
       This repairs those errors.
    Args:
        x (object): An element within the 'creators' or 'contributors'
        objects of the DOI metadata.

    Returns:
        object: A corrected contributors element.
    """
    x['affiliation']=['']
